...
class Nexysio(Spi):
    ...
    def gen_asic_pattern_part(self, value: bytearray, wload: bool, wload2: bool, 
        ...
        # data
            ...
            if wload:
                ...
                load.extend([0x00, LD2_ASIC, 0x00])
    ...
    def gen_asic_pattern(self, value: bytearray, wload: bool, wload2: bool, clkdiv: int = 8, 
        ...
        while length >= max_value:
            data.append(self.gen_asic_pattern_part(value[:max_value], False, False, clkdiv, readback_mode))
            value=value[max_value + 1:]
            length -= max_value
        else:
            data.append(self.gen_asic_pattern_part(value, wload, wload2, clkdiv, readback_mode))
